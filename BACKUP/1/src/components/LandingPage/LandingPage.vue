<template>
    <div class="w-full h-screen -z-10">
        <div class="intro flex flex-col items-end gap-6" :class="[isSmallDevice ? 'items-end' : '', isExtraSmallDevice ? 'items-end' : '']">
    ...
    <div class="main-bg -z-20">
        <video ref="backgroundVideo"autoplay muted loop class="w-full h-screen object-contain">
