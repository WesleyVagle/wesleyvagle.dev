<template>
    <div class="w-full bg-[var(--n2)] p-10 flex flex-col gap-10 rounded-2xl">
        <div>
            <h1 class="font-medium text-xl">Coding frameworks I've worked with:</h1>
        </div>
...
export default {
    ...
    data() {
        return {
            skills: [
                { name: "Framework:", level: "Experience level:", isTitle: true },
                { name: "Vue", level: "High" },
                { name: "Electron", level: "Good" },
                { name: "Tauri", level: "Good" },
                { name: "Docker", level: "Experimental" },
                { name: "React", level: "Experimental" },
                { name: "Angular", level: "Experimental" },
                { name: "Flutter", level: "Experimental" },
            ],
