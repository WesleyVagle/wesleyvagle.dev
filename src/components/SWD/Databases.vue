<template>
    <div class="w-full bg-[var(--n2)] p-10 flex flex-col gap-10 rounded-2xl">
        <div>
            <h1 class="font-medium text-xl">Databases I've worked with:</h1>
        </div>
...
export default {
    ...
    data() {
        return {
            skills: [
                { name: "Database:", level: "Experience level:", isTitle: true },
                { name: "MySQL", level: "Moderate" },
                { name: "MariaDB", level: "Moderate" },
                { name: "AWS DynamoDB", level: "Moderate" },
                { name: "Redis", level: "Experimental" },
            ],
